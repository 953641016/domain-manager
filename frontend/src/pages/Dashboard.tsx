    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-500">域名总数</p>
              <p className="text-2xl font-semibold text-gray-900">{stats.totalDomains}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats.expiringDomains}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-500">已完成申请</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">查询域名</p>
            </div>
          </button>
          ...
          >
            <div className="text-center">
              <span className="text-3xl">📋</span>
              <p className="mt-2 text-sm text-gray-600">查看申请</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-800">即将到期的域名</h2>
          <button
