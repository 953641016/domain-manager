...
class Config:
    ...
    SITE_DEPLOY_DNS_CHECK_TIMEOUT_SECONDS = int(os.getenv("SITE_DEPLOY_DNS_CHECK_TIMEOUT_SECONDS", "180"))
    SITE_DEPLOY_DNS_CHECK_INTERVAL_SECONDS = float(os.getenv("SITE_DEPLOY_DNS_CHECK_INTERVAL_SECONDS", "5"))
